...
//
// For a specific image, ask the camera for the image data and store it in the image object. There is progress bar support for this method.
//

  public void transferImageData(Image image)
  {
